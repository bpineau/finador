...
finador account add "PEA Zephyr"          --tax gains:17.2%  --alias pea --alias zephyr
finador account add "PEA-PME Aurora" --tax gains:17.2%  --alias pea-pme --alias pme
finador account add "AV Borealis"  --tax gains:30%    --alias av --alias borealis
finador account add "RSU (Lyra Wealth)"  --tax value:30%    --alias rsu     # free shares — see note below
...
```sh
# PEA Zephyr — its taxable basis becomes 40×380 + 5×900 = 19 700 € (≈ your contributions)
