...
| Enveloppes | Entité de premier rang, nom libre (« PEA Zephyr », « CTO Meridia »), multi-comptes par actif |
...
type Account struct {
    ID       AccountID // slug : "pea-zephyr", "cto-meridia"
    Name     string    // libellé libre : "PEA Zephyr", "CTO Meridia"
...
finador cash   set "CTO Meridia" 12500
