...
| seq | `k` | `d` (payload) |
|---|---|---|
| 1 | `acct` | `{"id":"06fc2cjx2bvtjjxmtmcj2wg","name":"PEA BforBank","ccy":"EUR","tax":"gains:17.2%","aliases":["pea"]}` |
...
|---|---|---|---|---|
| `06fc2cjx2bvtjjxmtmcj2wg` | PEA BforBank | EUR | gains:17.2% | `pea` |
...
|---|---|---|---|---|---|---|
| `06fc2cjy0zkkye41veyhr80` | 2024-01-15 | deposit | PEA BforBank | — | 0 | 10000 EUR |
| `06fc2cjy7j4ncgb2p6mg0a0` | 2024-01-20 | buy | PEA BforBank | CW8.PA | 20 | 9000 EUR |
