...
```sh
finador account add "PEA Zephyr" --tax gains:20%
finador cash deposit "PEA Zephyr" 150000 2020-01-01   # your contributions = the tax basis
finador cash set    "PEA Zephyr" 170000               # what it's worth today
```
...
`finador cash set "PEA Zephyr" 200000` — and the tax tracks the new excess
