...
const ftSearchEUR = `{"data":{"security":[
  {"name":"Independance Europe Small GBX","symbol":"LU1832174962:GBX","xid":"999999","isPrimary":false},
  {"name":"Independance Europe Small","symbol":"LU1832174962:EUR","xid":"118135654","isPrimary":true}
]}}`
...
func TestFTDaily(t *testing.T) {
	...
	got, err := f.Daily(context.Background(), Ref{ISIN: "LU1832174962"}, mustDate("2026-06-08"))
	if err != nil {
		t.Fatal(err)
	}
