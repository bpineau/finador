...
func TestTransactionJSONRoundTrip(t *testing.T) {
	...
	tx := Transaction{
		ID: "tx7", Date: d, Account: "pea-bforbank", Asset: "cw8", Kind: Buy,
	...
	want := `{"id":"tx7","date":"2026-06-01","account":"pea-bforbank","asset":"cw8","kind":"buy","qty":"10","amount":{"amount":"5500.5","ccy":"EUR"},"note":"premier achat"}`
	if string(raw) != want {
